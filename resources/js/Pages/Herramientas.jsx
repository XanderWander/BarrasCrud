        ...
        >
            ...
            <div>
                ...
                <div className='flex justify-between py-2'>
                    <a className="bg-blue-500 hover:bg-blue-700 text-white mx-5 font-bold py-2 px-4 rounded" target="_blank" href="http://localhost:8000/herramientas/pdf">Generar PDF</a>
                    <button onClick={openModal} className="bg-blue-500 hover:bg-blue-700 text-white mx-5 font-bold py-2 px-4 rounded">
                        Agregar Herramienta
                    </button>
